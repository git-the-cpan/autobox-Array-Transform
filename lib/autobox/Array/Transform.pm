...
autobox::Array::Transform provides a few higher level methods for
mapping, greping and sorting which are easier to read and write.
...
The methods of autobox::Array::Transform are not suitable for all
...
sub import {
    shift->SUPER::import( ARRAY => "autobox::Array::Transform::Array" );
}

sub throw {
    my ($error) = @_;
    $error =~ s/ at [\\\/\w ]*?lib.autobox.Array.Transform\.pm line \d+\.\n?$//;
...
sub __invoke_by {
    ...
    my $result = eval { $invoke_sub->() }
        or autobox::Array::Transform::throw($@);
...
sneaky way to call the gather_sub in the autobox::Array::Transform
...
L<https://github.com/jplindstrom/p5-autobox-Array-Transform>
...
L<https://github.com/jplindstrom/p5-autobox-Array-Transform/issues>.
